    ...
    >
      ...
      >
        <motion.div
          ...
          className="w-64 sm:w-80 rounded-3xlmax-w-none"
        >
          <Image src={assets.riya} alt="user" className="w-full rounded-3xl" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            , contributing to their innovation, success, and growth.
          </p>
